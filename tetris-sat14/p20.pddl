; from /home/guicho/repos/ipc2014-clean/tetris-sat14/p040.pddl
(define (problem Tetris-14-4-6381248)
(:domain tetris)
(:objects  
...
(at_right_l rightl1 f4-2f f5-2f f5-3f)
(at_right_l rightl2 f6-0f f7-0f f7-1f)
(at_right_l rightl3 f4-0f f5-0f f5-1f)
