; from /home/guicho/repos/ipc2014-clean/tetris-sat14/p038.pddl
(define (problem Tetris-14-4-1261185)
(:domain tetris)
(:objects  
...
(at_right_l rightl1 f0-1f f1-1f f1-2f)
(at_right_l rightl2 f6-0f f7-0f f7-1f)
(at_right_l rightl3 f5-2f f6-2f f6-3f)
(at_two straight0 f0-0f f1-0f)
(at_two straight1 f4-1f f5-1f)
(at_square square0 f4-0f)
(at_square square1 f4-2f)
(at_square square2 f5-0f)
(at_square square3 f6-1f)
(= (total-cost) 0)
)
(:goal
(and
