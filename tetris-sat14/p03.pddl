; from /home/guicho/repos/ipc2014-clean/tetris-sat14/p022.pddl
(define (problem Tetris-12-4-8274938)
(:domain tetris)
(:objects  
...
(at_right_l rightl1 f1-0f f2-0f f2-1f)
(at_two straight0 f0-2f f1-2f)
(at_two straight1 f4-2f f5-2f)
