; from /home/guicho/repos/ipc2014-clean/tetris-sat14/p037.pddl
(define (problem Tetris-14-4-6791404)
(:domain tetris)
(:objects  
...
(at_two straight3 f4-0f f5-0f)
(at_two straight4 f4-2f f5-2f)
(at_two straight5 f5-1f f6-1f)
