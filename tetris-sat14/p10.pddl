; from /home/guicho/repos/ipc2014-clean/tetris-sat14/p029.pddl
(define (problem Tetris-12-4-5180176)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 - one_square
...
(clear f11-2f)
(clear f11-3f)
(at_right_l rightl0 f5-2f f6-2f f6-3f)
(at_two straight0 f0-1f f1-1f)
(at_two straight1 f1-0f f2-0f)
(at_two straight2 f2-1f f3-1f)
(at_two straight3 f2-2f f3-2f)
(at_square square0 f0-2f)
(at_square square1 f1-2f)
(at_square square2 f3-0f)
(at_square square3 f4-2f)
(at_square square4 f5-0f)
(at_square square5 f5-1f)
(= (total-cost) 0)
)
(:goal
(and
