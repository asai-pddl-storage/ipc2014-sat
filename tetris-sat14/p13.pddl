; from /home/guicho/repos/ipc2014-clean/tetris-sat14/p033.pddl
(define (problem Tetris-14-4-3565651)
(:domain tetris)
(:objects  
...
(clear f13-2f)
(clear f13-3f)
(at_right_l rightl0 f6-2f f7-2f f7-3f)
(at_right_l rightl1 f4-0f f5-0f f5-1f)
...
(at_two straight2 f1-0f f2-0f)
(at_square square0 f4-1f)
(at_square square1 f6-1f)
(= (total-cost) 0)
)
(:goal
(and
